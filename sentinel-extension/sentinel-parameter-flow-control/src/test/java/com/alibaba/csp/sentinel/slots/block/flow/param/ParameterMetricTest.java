...
public class ParameterMetricTest {
    ...
    public void testInitAndClearParameterMetric() {
        ...
        CacheMap<Object, RAtomicLong> threadCountMap =
                metric.getThreadCountMap().get(rule.getParamIdx());
        assertNotNull(threadCountMap);
        CacheMap<Object, RAtomicLong> timeRecordMap = metric.getRuleTimeCounter(rule);
        ...
        CacheMap<Object, RAtomicLong> timeRecordMap2 = metric.getRuleTimeCounter(rule2);
        ...
        ParamFlowRule rule3 = new ParamFlowRule("abc").setParamIdx(1)
